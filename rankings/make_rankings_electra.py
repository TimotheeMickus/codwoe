...
df = pd.read_csv('submission_scores/res_revdict-electra.csv')
...
df.to_csv('submission_ranks/results_revdict-electra-rankings.csv', index=False)
...
df_ranks.to_csv('final_rankings/revdict-electra_rankings-per-users.csv')
