...
df = pd.read_csv('submission_scores/res_revdict-sgns.csv')
...
df.to_csv('submission_ranks/results_revdict-sgns-rankings.csv', index=False)
...
df_ranks.to_csv('final_rankings/revdict-sgns_rankings-per-users.csv')
